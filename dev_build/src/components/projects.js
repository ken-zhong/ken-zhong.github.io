  ...
  <div className='modal'>
    ...
    <main>
      <div className='project-item'>
        <div className='project-img'> <img src={PxlImg} /> </div>
        <h3><a href='https://pxl-on.herokuapp.com/#/'>Pxl-On</a></h3>
        <div className='project-description'>
          <p>A full stack photo sharing app inspired by 500px and Instagram, built using
            ...
            <a href='https://pxl-on.herokuapp.com/' rel='noopener noreferrer'
      ...
      <div className='project-item'>
        <div className='project-img'> <img src={PlasmaforceImg} /> </div>
        <h3><a href='https://kenzhong.me/plasmaforce/' >Plasmaforce</a></h3>
        <div className='project-description'>
          <p>A sidescrolling 2d space shooter built using JavaScript, HTML5, and lots of
            object-oriented programming.&nbsp;
            <a href='https://ken-zhong.github.io/plasmaforce/'
              rel='noopener noreferrer' target='_blank'>Live</a> |&nbsp;
            <a href='https://github.com/ken-zhong/plasmaforce'
              rel='noopener noreferrer' target='_blank'>Repo</a>
          </p>
        </div>
      </div>
      ...
      <div className='project-item'>
        <div className='project-img'> <img src={PictusImg} /> </div>
        <h3><a href='https://pictus-whiteboard.herokuapp.com/'>Pictus Whiteboard</a></h3>
        <div className='project-description'>
          <p>A whiteboarding app that connects users together with WebSockets and allows them to
            ...
            Socket.io.&nbsp;
            <a href='https://pictus-whiteboard.herokuapp.com/'
              rel='noopener noreferrer' target='_blank'>Live</a> |&nbsp;
            <a href='https://github.com/ken-zhong/pictus'
              rel='noopener noreferrer' target='_blank'>Repo</a>
          </p>
        </div>
      </div>
